    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f4f7f4] via-white to-[#f4f7f4]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
        ...
        <motion.section 
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1 }}
          className="relative mt-16 md:mt-32 pt-16 md:pt-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl overflow-hidden"
        >
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-slate-800/20 via-transparent to-transparent"></div>
            ...
            <motion.div
              ...
              className="absolute top-1/4 left-1/4 w-48 md:w-96 h-48 md:h-96 bg-slate-700/30 rounded-full blur-3xl"
            />
            <motion.div
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ 
              ...
              className="absolute bottom-1/3 right-1/3 w-48 md:w-96 h-48 md:h-96 bg-slate-600/20 rounded-full blur-3xl"
            />
          </div>
          ...
          <div className="relative container mx-auto px-4 py-16 md:py-24 flex flex-col items-center justify-center min-h-[80vh] md:min-h-screen">
            ...
            >
              ...
              >
                <Link 
                  ...
                  className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-medium text-white bg-slate-700 rounded-full overflow-hidden transition-all duration-300 hover:bg-slate-600 w-full sm:w-auto"
                >
                  ...
                  <motion.div
                    ...
                    whileHover={{ x: "100%" }}
                    transition={{ duration: 1 }}
                    className="absolute inset-0 bg-gradient-to-r from-slate-600 via-slate-500 to-slate-600 opacity-50"
                  />
                </Link>
              </motion.div>
            </motion.div>
            ...
            <motion.div
              ...
              className="hidden md:block absolute left-10 top-1/4 w-24 h-24 border border-slate-500/30 rounded-full"
            />
            <motion.div
              animate={{ 
                rotate: -360,
              ...
              className="hidden md:block absolute right-10 bottom-1/4 w-32 h-32 border-2 border-slate-500/20 rounded-full"
            />
          </div>
        </motion.section>
      </div>
