      ...
      <main className="min-h-screen bg-gradient-to-b from-neutral-50 to-primary-50/20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="relative z-10">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-light text-neutral-800 mb-4 md:mb-6">
                Kontakt
              </h1>
              <div className="h-px w-24 bg-primary-500 mx-auto mb-6 md:mb-8" />
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-lg"
              >
              ...
              >
                {/* Office Information */}
                <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-lg">
                  <h3 className="text-xl md:text-2xl font-light text-neutral-800 mb-4 md:mb-6">Büro</h3>
                  <div className="space-y-3 md:space-y-4 text-neutral-600">
                    <p>Richard Mütze</p>
                ...
                {/* Contact Details */}
                <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-lg">
                  <h3 className="text-xl md:text-2xl font-light text-neutral-800 mb-4 md:mb-6">Kontaktdaten</h3>
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <a href="mailto:muetze@arc-muetze.de" className="block text-neutral-600 hover:text-primary-500 transition-colors break-words">
