...
const QuoteIcon = () => (
  <svg className="w-12 h-12 text-nature-teal/20" viewBox="0 0 50 50" fill="currentColor">
...
export function Testimonials() {
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-nature-sand/5">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="relative p-8 h-full">
                <div className={`absolute inset-0 bg-gradient-to-br ${testimonial.gradientFrom} ${testimonial.gradientTo} rounded-3xl opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />
                
                <div className="relative">
                  <div className="mb-6 text-nature-sage">
                    <QuoteIcon />
                  </div>
                  ...
                  >
                    {testimonial.quote.split(" ").map((word, i) => (
                      <motion.span
                        ...
                        className="inline-block mr-1 text-lg text-nature-darkBrown/80"
                      >
                        {word}
                      </motion.span>
                    ))}
                  ...
                  >
                    <div className="font-medium text-nature-darkBrown">
                      {testimonial.author}
                    </div>
                    <div className="text-sm text-nature-darkBrown/60 mt-1">
                      {testimonial.role}
                    </div>
                  </motion.footer>
                </div>
